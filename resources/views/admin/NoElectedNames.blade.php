        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">غير المنتخبين</h3>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card codecard">
                                <div class="card-header">
                                    <h4 class="card-title">غير المنتخبين</h4>
                                </div>
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered file-export col-l-12" style="width: 100%!important;">
                                            ...
                                            @include('components.NEnamesfiltered')
                                        </table>
                                    </div>
                                </div>
                            </div>
